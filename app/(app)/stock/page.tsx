...
export default function StockPage() {
  ...
  return (
    <div className="w-full px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
      <div className="relative grid w-full grid-cols-1 gap-14 lg:grid-cols-2 lg:items-start">
        <section className="flex w-full justify-center">
          <div className="w-full max-w-2xl">
            ...
            <div className="mb-14 flex flex-col gap-6 lg:hidden">
              ...
              <Button
                ...
                disabled={items.length === 0 || clearStockLoading}
              >
      ...
      <ConfirmModal
        open={isClearStockConfirmOpen}
        onClose={() => {
          if (!clearStockLoading) setIsClearStockConfirmOpen(false);
        }}
        onConfirm={handleClearStock}
        title={t("stockSection.clearStockConfirmTitle")}
        description={t("stockSection.clearStockConfirmDescription")}
        confirmLabel={t("stockSection.clearStockConfirmButton")}
        cancelLabel={t("stockSection.cancelButton")}
        loading={clearStockLoading}
        danger
      />
    </div>
