...
export default function MenuPage() {
  ...
  const [isClearMenuConfirmOpen, setIsClearMenuConfirmOpen] = useState(false);
  ...
  async function handleClearMenu() {
    ...
    try {
      ...
      await load();
      setIsClearMenuConfirmOpen(false);
    } finally {
  ...
  return (
    <div className="w-full px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
      <div className="relative grid w-full grid-cols-1 gap-14 lg:grid-cols-2 lg:items-start">
        ...
        <section className="flex w-full justify-center">
          <div className="w-full max-w-2xl">
            <div className="mb-14 flex flex-col gap-6 sm:mb-6 sm:flex-row sm:items-center sm:justify-between sm:gap-4 lg:mb-10 lg:gap-8 xl:gap-10">
              ...
              <Button
                ...
                onClick={() => setIsClearMenuConfirmOpen(true)}
                className="w-1/2 flex-1 sm:w-auto"
                disabled={menuItems.length === 0 || clearMenuLoading}
              >
      ...
      <ConfirmModal
        open={isClearMenuConfirmOpen}
        onClose={() => {
          if (!clearMenuLoading) setIsClearMenuConfirmOpen(false);
        }}
        onConfirm={handleClearMenu}
        title={t("listSection.clearConfirmTitle")}
        description={t("listSection.clearConfirmDescription")}
        confirmLabel={t("listSection.clearConfirmButton")}
        cancelLabel={t("listSection.cancelButton")}
        loading={clearMenuLoading}
        danger
      />
    </div>
